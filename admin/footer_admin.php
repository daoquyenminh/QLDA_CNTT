...
<script type="text/javascript" src="http://localhost/BTL/assets/js/myscript.js"></script>
<script type="text/javascript" src="http://localhost/BTL/index2.php"></script>
<script type="text/javascript" src="http://localhost/BTL/admin/js/ajax.js">
</script>
<script type="text/javascript" src="http://localhost/BTL/admin/js/prosecer_delete.js"></script>
