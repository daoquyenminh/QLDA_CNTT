...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/BTL/assets/css/responsive.css">
    <link rel="stylesheet" href="http://localhost/BTL/assets/css/style.css">
    <link rel="stylesheet" href="http://localhost/BTL/admin/css/delete.css">
                ...
                <div class="col-md-12 p-0">
                    <nav class="navbar navbar-expand-lg navbar-light bgroud-orange fw-bolder fs-6 ">
                        <div class="container  ">
                            ...
                            <a class="navbar-brand " href="http://localhost/BTL/index.php">
                            ...
                            <div class="collapse navbar-collapse" id="navbarScroll">
                                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll " style="--bs-scroll-height: 100px;">
                                    <li class="nav-item">
                                        <a class="nav-link text-dark " aria-current="page" href="http://localhost/BTL/admin/index.php"> Admin</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link text-dark" href="http://localhost/BTL/admin/user.php">Quản lý Bài Giảng</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active text-dark" aria-current="page" href="http://localhost/BTL/admin/QLMonHoc.php">Quản lý môn học</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-dark" href="http://localhost/BTL/admin/QLsinhvien.php">Quản lý học sinh</a>
                                    </li>
                                </ul>
                                <form class="d-flex ">
                                ...
                                <div class="dropdown text-end mr-4 drop-logout">
                                    ...
                                    <ul class="dropdown-menu  " style=" min-width: 6rem;" aria-labelledby="dropdownUser1">
                                        ...
                                        <li><a class="dropdown-item" href="http://localhost/BTL/admin/check_QTV.php">Thêm giáo viên</a></li>
                                        <li><a class="dropdown-item" href="http://localhost/BTL/logout.php">Đăng xuất</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
